...
struct Z_CompiledInDeferFile_FID_SizeShift_Source_SizeShift_SizeShiftPlayerCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASizeShiftPlayerCharacter, ASizeShiftPlayerCharacter::StaticClass, TEXT("ASizeShiftPlayerCharacter"), &Z_Registration_Info_UClass_ASizeShiftPlayerCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASizeShiftPlayerCharacter), 3867351351U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SizeShift_Source_SizeShift_SizeShiftPlayerCharacter_h_1846973194(TEXT("/Script/SizeShift"),
